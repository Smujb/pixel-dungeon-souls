...
public class WelcomeScene extends PixelScene {
	...
	private static final int LATEST_UPDATE = PDSGame.v0_4_12;
	...
	public void create() {
		...
		if (PDSGame.versionCode == previousVersion) {
		...
		StyledButton okay = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				if (previousVersion == 0){
					PPDSettings.version(PDSGame.versionCode);
		...
		} else if (previousVersion <= PDSGame.versionCode) {
