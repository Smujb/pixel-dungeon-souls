...
public class HeroSelectScene extends PixelScene {
	...
	public void create() {
		...
		infoButton = new IconButton(Icons.get(Icons.INFO)){
			...
			protected void onClick() {
				super.onClick();
				PDSGame.scene().addToFront(new WndHeroInfo(GamesInProgress.selectedClass));
			}
		};
		...
		challengeButton = new IconButton(
			...
			@Override
			protected void onClick() {
				PDSGame.scene().addToFront(new WndChallenges(PPDSettings.challenges(), true) {
	...
	private class HeroBtn extends StyledButton {
		...
		protected void onClick() {
			...
			if( cl.locked() ){
				PDSGame.scene().addToFront( new WndMessage(cl.unlockMsg()));
			} else if (GamesInProgress.selectedClass == cl) {
				PDSGame.scene().add(new WndHeroInfo(cl));
			} else {
				setSelectedHero(cl);
			}
		}
