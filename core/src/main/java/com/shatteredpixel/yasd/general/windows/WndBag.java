...
public class WndBag extends WndTabbed {
	...
	private class ItemButton extends ItemSlot {
		...
		protected boolean onLongClick() {
			if (listener == null) {
				hide();
				PDSGame.platform.promptTextInput(Messages.get(this, "rename_title"), item.name(), 20, false, Messages.get(this, "confirm"), Messages.get(this, "cancel"), new PlatformSupport.TextCallback() {
					@Override
